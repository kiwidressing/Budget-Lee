...
### 4. 🔄 고정지출 관리 (Fixed Expenses) ⭐ **NEW**
- 정기적 지출 스케줄 관리
- **월별 고정지출**: 매월 N번째 특정 요일 (예: 매월 첫째 주 목요일)
- **주별 고정지출**: 매주 특정 요일 → 해당 월의 모든 반복 표시 (4-5개 인스턴스)
...
### Frontend
- **Vanilla JavaScript** - 순수 JavaScript (2,541 줄) ⭐ **+1,502줄 추가**
...
webapp/
├── src/
│   └── index.tsx              # Hono 백엔드 API (807 줄, 31개 엔드포인트) ⭐
├── public/
│   ├── manifest.json          # PWA 매니페스트
│   ├── sw.js                  # Service Worker
│   └── static/
│       ├── app.js             # 프론트엔드 JavaScript (2,541 줄) ⭐ **+1,502줄**
│       └── style.css          # 커스텀 CSS
├── migrations/
